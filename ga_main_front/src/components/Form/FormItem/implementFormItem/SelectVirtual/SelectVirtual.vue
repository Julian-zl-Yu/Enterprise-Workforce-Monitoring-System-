<template>
  ...
  >
    ...
    >
      ...
      >
        <VirtualList
          v-if="visible && emptyText !== false"
          style="height: 360px; overflow-y: auto"
          :data-key="'value'"
          :data-sources="selectOptions"
          :data-component="SelectVirtualItem"
          :keeps="40"
        />
        <!-- <el-scrollbar
...
import SelectVirtualItem from "./SelectVirtualItem";
...
import _isNull from "lodash/isNil";
...
export default {
  ...
  methods: {
    ...
    getOption(value) {
      ...
      option = _find(this.selectOptions, (options) => options.value === value);
      if (option)
        return _merge(
          {
            value: value,
