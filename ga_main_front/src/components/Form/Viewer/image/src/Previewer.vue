<template>
  <transition name="viewer-fade">
    ...
    >
      ...
      <!-- ACTIONS -->
      <div
        v-if="FILE_TYPE[FILE_TYPE.img] === currentItem.viewType"
      ...
      <div
        ...
        :data-index="index"
        :data-type="currentItem.viewType"
        :style="imgStyle"
      >
        <!-- {{ $log(JSON.stringify(currentItem,null,2)) }} -->
        <img
          v-if="FILE_TYPE[FILE_TYPE.img] === currentItem.viewType"
          ref="img"
          :key="currentItem.id"
...
import { FILE_TYPE } from "@/components/Types";
