<template>
  <div>
    <ren-process-start 
      ...
      ref="renProcessStart" 
      :save-form-url="saveFormUrl" 
      :update-instance-id-url="updateInstanceIdUrl" 
      :data-form-name="dataFormName"
    />
    <ren-process-running 
      v-if="runningHandleVisible" 
      ref="renProcessRunning"
    />
    <ren-process-detail 
      v-if="processDetailVisible" 
      ref="renProcessDetail"
    />
  </div>
</template>
