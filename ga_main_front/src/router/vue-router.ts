...
function createMatcher(
  ...
  /* 根据routes创建map list path name ，list用于路由匹配 */
...
/* 入口 */
var VueRouter = function VueRouter(options: object) {
...
VueRouter.prototype.addRoutes = function addRoutes(routes) {
  ...
  /* TODO: this.history.current 与  this.history.getCurrentLocation() 是什么关系？*/
  // if (this.history.current !== START) {
  const currentLocationPath = this.history.getCurrentLocation();
  if (this.history.current.path !== currentLocationPath) {
    this.history.transitionTo(currentLocationPath);
  }
};
