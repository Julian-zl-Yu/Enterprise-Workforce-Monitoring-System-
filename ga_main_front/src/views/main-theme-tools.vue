<template>
  <div 
    :class="{ 'app-theme-tools--open': isOpen }" 
    class="app-theme-tools"
  >
    <div 
      class="app-theme-tools__toggle" 
      @click="isOpen = !isOpen"
    >
      <svg 
        class="icon-svg" 
    ...
    <div class="app-theme-tools__content">
      <div class="app-theme-tools__item">
        <h3>Navbar</h3>
        <el-checkbox 
    ...
    methods: {
        themeColorChangeHandle (val) {
            var styleList = [
                ...
                {
                    id: "J_uiTheme",
                    url: `${process.env.BASE_URL}element-theme/${val}/ui.css?t=${new Date().getTime()}`
                }
            ];
