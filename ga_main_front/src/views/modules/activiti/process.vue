...
export default {
  ...
  methods: {
    ...
    activeHandle(id) {
      this.$confirm(
        this.$t("prompt.info", { handle: this.$t("process.active") }),
        this.$t("prompt.title"),
        {
    ...
    suspendHandle(id) {
      this.$confirm(
        this.$t("prompt.info", { handle: this.$t("process.suspend") }),
        this.$t("prompt.title"),
        {
          confirmButtonText: this.$t("confirm"),
          cancelButtonText: this.$t("cancel"),
    ...
    convertToModelHandle(id) {
      this.$confirm(
        this.$t("prompt.info", { handle: this.$t("process.convertToModel") }),
        this.$t("prompt.title"),
        {
          confirmButtonText: this.$t("confirm"),
          cancelButtonText: this.$t("cancel"),
        ...
        .then(() => {
          this.$http
            .post(`/act/process/convertToModel/${id}`)
            .then(({ data: res }) => {
              if (res.code !== 0) {
                return this.$message.error(res.msg);
              }
