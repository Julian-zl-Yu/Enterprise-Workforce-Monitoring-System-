...
/*模块名*/
const moduleName = "enterprise-cp03Config-cp03Config";
/* 查询框store名 */
        ...
        btnList: [
          {
            ...
            shiro: "enterprise:cp03config:info",
            click: (scope) =>
              _this.goSub({ v: "detail", id: scope.row.id }),
          },
          {
            type: BTN_TYPE.update,
            shiro: "enterprise:cp03config:update",
            click: (scope) =>
