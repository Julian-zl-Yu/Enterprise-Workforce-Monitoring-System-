...
/*模块名*/
const moduleName = "enterprise-pj07-pj07";
/* 查询框store名 */
        ...
        btnList: [
          {
            ...
            shiro: "enterprise:pj07:info",
            click: (scope) =>
              _this.goSub({ v: "detail", id: scope.row.pj0701 }),
          },
          {
            type: BTN_TYPE.update,
            shiro: "enterprise:pj07:update",
            click: (scope) =>
              _this.goSub({ v: "update", id: scope.row.pj0701 }),
          }
        ],
      },
