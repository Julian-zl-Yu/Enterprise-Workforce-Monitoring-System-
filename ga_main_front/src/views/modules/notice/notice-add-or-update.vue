...
export default {
    ...
    methods: {
        ...
        // 富文本编辑器
        quillEditorHandle () {
            this.quillEditor = new Quill("#J_quillEditor_notice", {
                modules: {
            ...
            // 自定义上传图片功能 (使用element upload组件)
            this.uploadUrl = `${SITE_CONFIG["apiURL"]}/sys/oss/upload?token=${Cookies.get("token")}`;
