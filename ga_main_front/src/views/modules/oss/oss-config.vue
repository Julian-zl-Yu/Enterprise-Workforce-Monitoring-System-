  ...
  >
    ...
    >
      ...
      <template v-else-if="dataForm.type === 6">
        <el-form-item 
          :label="$t('oss.minioEndPoint')" 
          prop="minioEndPoint"
        >
          <el-input 
            v-model="dataForm.minioEndPoint" 
            :placeholder="$t('oss.minioEndPointTips')"
          />
        </el-form-item>
        <el-form-item 
          :label="$t('oss.minioAccessKey')" 
          prop="minioAccessKey"
        >
          <el-input 
            v-model="dataForm.minioAccessKey" 
            :placeholder="$t('oss.minioAccessKeyTips')"
          />
        </el-form-item>
        <el-form-item 
          :label="$t('oss.minioSecretKey')" 
          prop="minioSecretKey"
        >
          <el-input 
            v-model="dataForm.minioSecretKey" 
            :placeholder="$t('oss.minioSecretKeyTips')"
          />
        </el-form-item>
        <el-form-item 
          :label="$t('oss.minioBucketName')" 
          prop="minioBucketName"
        >
          <el-input 
            v-model="dataForm.minioBucketName" 
            :placeholder="$t('oss.minioBucketNameTips')"
          />
        </el-form-item>
        <el-form-item 
          :label="$t('oss.minioPrefix')" 
          prop="minioPrefix"
        >
          <el-input 
            v-model="dataForm.minioPrefix" 
            :placeholder="$t('oss.minioPrefixTips')"
          />
        </el-form-item>
      </template>
    </el-form>
