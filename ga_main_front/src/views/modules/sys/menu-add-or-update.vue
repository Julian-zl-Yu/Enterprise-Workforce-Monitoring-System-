  ...
  >
    ...
    >
      ...
      <el-form-item label="是否显示" prop="type">
        <!-- <ren-radio-group v-model="dataForm.whether" dict-type="WHETHER" /> -->
        <el-radio v-model="dataForm.whether" label="1">是</el-radio>
        <el-radio v-model="dataForm.whether" label="0">否</el-radio>
      </el-form-item>
    </el-form>
