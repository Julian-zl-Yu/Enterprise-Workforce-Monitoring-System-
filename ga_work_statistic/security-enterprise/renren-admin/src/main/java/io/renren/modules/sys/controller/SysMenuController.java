...
public class SysMenuController {
	...
	@GetMapping("roleNav/{roleId}")
	@ApiOperation("根据角色获取菜单")
	public Result<List<SysMenuDTO>> roleNav(@PathVariable("roleId") Long roleId) {
		List<SysMenuDTO> list = sysMenuService.getUserRoleMenuList(roleId, MenuTypeEnum.MENU.value());
		return new Result<List<SysMenuDTO>>().ok(list);
	}
}