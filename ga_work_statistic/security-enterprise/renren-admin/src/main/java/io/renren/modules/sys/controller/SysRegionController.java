...
public class SysRegionController {
	...
	@GetMapping("" +
			"")
	@ApiOperation("获取版本号")
	public Result<String> regionVersion() {

		String timestamp = sysRegionService.loadRegionVersion();

		return new Result<String>().ok(timestamp);
	}

	@GetMapping("regionUpdate")
	@ApiOperation("获取地区数据")
	public Result<List<SysRegionDTO>> regionUpdate() {

		List<SysRegionDTO> list = sysRegionService.loadRegionData();
