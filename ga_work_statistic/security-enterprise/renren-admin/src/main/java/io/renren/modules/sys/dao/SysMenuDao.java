...
public interface SysMenuDao extends BaseDao<SysMenuEntity> {
    ...
    List<SysMenuEntity> getAdminMenuList(Integer type, String language);

	List<SysMenuEntity> getUserRoleMenuList(Long roleId, Long id, Integer type, String language);
}
